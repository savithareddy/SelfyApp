...
-(void) signUp
{
    ...
    UIImage *avatarImage = [UIImage imageNamed:@"Avatar.png"];// image can be named other as @"boss"
   NSData *imageData = UIImagePNGRepresentation(avatarImage);
   // NSData *imageData = UIImagePNGRepresentation(avatar.image); // if we have the image
