...
@interface SLFHsbViewController ()

@end

@implementation SLFHsbViewController
{
...
-(void)applyFilter
{
    ...
    [self.delegate updateCurrentImageWithFilteredImage:(UIImage *)newImage];
}
